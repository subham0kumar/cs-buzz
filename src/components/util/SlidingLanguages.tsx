...
const SlidingLanguages = (props: Props) => {
  ...
  return (
    <div className="bg-[#F1F1F1] flex justify-center items-center px-2">
      <button onClick={() => scrollSlider("left")}>
        <ChevronLeft color="#FBC108" />
      </button>
      <div
        ref={sliderRef}
        className="flex gap-3 py-2 mx-2 overflow-x-scroll scrollbar-hidden whitespace-nowrap text-xs"
      >
